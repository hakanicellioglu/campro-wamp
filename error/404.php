...
<main>
    ...
    <p>Bağlantı kırılmış olabilir ya da sayfa kaldırılmış olabilir. Doğru adreste olduğunuzdan emin olun.</p>
    <div class="actions">
        <a class="button primary" href="/">Ana sayfaya dön</a>
        <a class="button secondary" href="javascript:history.back()">Önceki sayfaya git</a>
    </div>
    <footer>Hâlâ bulamadıysanız arama çubuğunu kullanmayı deneyin veya destek ekibimize yazın.</footer>
</main>
</body>
</html>
